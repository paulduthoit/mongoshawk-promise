...
SchemaTypeObjectId.validate = function(value) {
    ...
    if(typeof value === 'object' && value !== null && value.constructor.name === 'ObjectID') return true;
...
SchemaTypeObjectId.convert = function(value) {
    ...
    if(typeof value === 'object' && value !== null && value.constructor.name === 'ObjectID') return value;
